...
config.imgDir = "https://cfx-nui-vrp/config/inventory/" -- DIRETORIO DAS IMAGENS DA SUA BASE
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- TRADUÇOES
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
config.lang = {
    notPermiss = function() TriggerEvent("Notify","negado","Você não possui permissão para isso.") end,
}
...
src.playAnim = function(anim)
    ...
    if not anim or not anim[1] or not anim[2] then return end
    ...
    TaskPlayAnim(ped, anim[1], anim[2], 3.0, 3.0, -1, 49, 0, false, false, false)
end

src.playCraftAnim = function(anim)
    local ped = PlayerPedId()
    if not anim or not anim[1] or not anim[2] then return end
