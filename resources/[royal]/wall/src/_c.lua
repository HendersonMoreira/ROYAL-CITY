...
AddEventHandler(GlobalState["Creative_wall"]..":wall",function(val)
    ...
    if wall then
        ...
        TriggerEvent("Notify","vermelho","Wall Desativado!.",2500)
                    ...
                    if ((NetworkIsPlayerActive( id ))) then
                        ...
                        if nped_id ~= -1 and wall_users[src] ~= nil then
                            ...
                            if GetDistanceBetweenCoords(x, y, z, px, py, pz, true) <= walldistance then
                                ...
                                local default = "~r~["..(wall_users[src].Passport or "não identificado").."] ~r~"..(wall_users[src].name or "não identificado").."\n~w~Health:~g~"..health.." ~e~| Armour:~b~"..armour.."~r~"
