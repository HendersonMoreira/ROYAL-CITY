...
local List = {
	{ -- Cow
		...
		["Distance"] = 30,
		["Coords"] = vec4(-1650.97,-995.93,13.01,229.61),
		["Model"] = "a_f_y_eastsa_03",
		["Anim"] = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},{ -- npc rota elements
		["Distance"] = 30,
		["Coords"] = vec4(-1687.45,936.89,177.6,323.15),
		["Model"] = "ig_claypain",
		["Anim"] = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},{ -- npc rota distrito22
		["Distance"] = 30,
		["Coords"] = vec4(-1755.23,-202.43,57.85,317.49),
		["Model"] = "ig_claypain",
		["Anim"] = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},{ -- npc rota Turquia 
		["Distance"] = 30,
		["Coords"] = vec4(1385.41,-757.84,78.99,68.04),
		["Model"] = "ig_claypain",
		["Anim"] = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},{ -- npc rota Turquia  
		["Distance"] = 30,
		["Coords"] = vec4(1213.88,-260.32,75.77,76.54),
		["Model"] = "ig_claypain",
		["Anim"] = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},{ -- bus  
		["Distance"] = 30,
		["Coords"] = vec4(1484.25,1129.98,114.33,90.71),
		["Model"] = "ig_claypain",
		["Anim"] = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- Ifood
		["Distance"] = 30,
		["Coords"] = vec4(-1183.22,-884.28,13.75,308.98),
		["Model"] = "ig_claypain",
		["Anim"] = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- Mecanico Buy 
		["Distance"] = 30,
		["Coords"] = vec4(-2075.88,-517.79,12.11,48.19),
		["Model"] = "mp_m_shopkeep_01",
		["Anim"] = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- Mecanico Public 
		["Distance"] = 30,
		["Coords"] = vec4(-2038.5,-491.24,12.11,320.32),
		["Model"] = "mp_m_shopkeep_01",
		["Anim"] = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- NPC de Heroina 
		["Distance"] = 30,
		["Coords"] = vec4(-439.63,6337.84,12.72,42.52),
		["Model"] = "g_m_y_salvagoon_01",
		["Anim"] = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- NPC de Maconha 
		["Distance"] = 30,
		["Coords"] = vec4(1721.11,3320.22,41.21,195.6),
		["Model"] = "g_m_y_strpunk_02",
		["Anim"] = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- NPC de Crack 
		["Distance"] = 30,
		["Coords"] = vec4(2403.74,3127.8,48.16,255.12),
		["Model"] = "a_m_y_methhead_01",
		["Anim"] = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- NPC da Cocaína 
		["Distance"] = 30,
		["Coords"] = vec4(492.36,-507.23,24.77,266.46),
		["Model"] = "mp_m_cocaine_01",
		["Anim"] = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- NPC da Metanfetamina 
		["Distance"] = 30,
		["Coords"] = vec4(-412.79,-1683.52,19.02,65.2),
		["Model"] = "ig_claypain",
		["Anim"] = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- NPC da Super Droga
		["Distance"] = 30,
		["Coords"] = vec4(2428.62,4970.25,42.34,226.78),
		["Model"] = "s_m_y_factory_01",
		["Anim"] = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- NPC da rota da italia
		["Distance"] = 30,
		["Coords"] = vec4(-3140.61,1414.98,23.24,325.99),
