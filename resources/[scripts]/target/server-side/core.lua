...
function Creative.CheckIn()
	...
	local Passport = vRP.Passport(source)
	if Passport then
		local _,Paramedics = vRP.NumPermission("Paramedico")
		if Paramedics > 0 then
			TriggerClientEvent("Notify",source,"Centro Médico","Existem paramédicos em serviço. Deite na maca e aguarde atendimento.","amarelo",5000)
			return false,true
		end
