Works = {
    ...
    ifood = {
        ...
        locations = {
            vec3(197.78,-1725.59,29.66),
		    vec3(512.13,-1790.62,28.91),
		    vec3(322.09,-940.65,29.4),
		    vec3(559.39,-1776.93,33.45),
		    vec3(415.51,-924.73,29.4),
		    vec3(-113.64,-1468.41,33.82),
		    vec3(-34.18,-1846.99,26.18),
		    vec3(263.49,-1346.42,31.91),
		    vec3(-40.56,-1082.04,26.61),
		    vec3(-319.92,-1389.67,36.5)
        }
    }
}