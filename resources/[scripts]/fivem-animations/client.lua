...
local animacoes = {
    ...
    { nome = "mexer2",      dict = "mp_arresting",                                               anim = "a_uncuff",                        andar = true,                  loop = true },
    ...
    { nome = "garcom",         dict = "anim@move_f@waitress",                                                                anim = "idle",                                              prop = "vw_prop_vw_tray_01a", flag = 50,    hand = 28422 },
    ...
    { nome = "roubar",         dict = "oddjobs@shop_robbery@rob_till",                                                       anim = "loop",                                              andar = false,                loop = true },
    { nome = "revistar",       dict = "misscarsteal4@director_grip",                                                         anim = "end_loop_grip",                                     andar = false,                loop = true },
    {
        nome = "mijar",
        ...
        extra = function()
            ...
            SetTimeout(500, function()
                effect = StartParticleFxLoopedOnPedBone("ent_amb_peeing", PlayerPedId(), 0.0, 0.2, 0.0, -140.0, 0.0, 0.0,
                    GetPedBoneIndex(PlayerPedId(), 11816), 2.5, false, false, false)
                Citizen.Wait(5500)
    ...
    },
    {
        ...
        extra = function()
            ...
            SetTimeout(1000, function()
                effect = StartParticleFxLoopedOnPedBone("ent_anim_dog_poo", PlayerPedId(), 0.0, 0.0, -0.6, 0.0, 0.0, 20.0,
                    GetPedBoneIndex(PlayerPedId(), 11816), 2.0, false, false, false)
                effect2 = StartParticleFxLoopedOnPedBone("ent_anim_dog_poo", PlayerPedId(), 0.0, 0.0, -0.6, 0.0, 0.0,
                    20.0, GetPedBoneIndex(PlayerPedId(), 11816), 2.0, false, false, false)
                Citizen.Wait(1000)
                StopParticleFxLooped(effect, 0)
...
RegisterCommand("e", function(_, args, rawCommand)
    local ped = PlayerPedId()
    local nome = args[1]
...
RegisterCommand("handsup", function(_, args, rawCommand)
    handsUp = not handsUp

    if handsUp then
        SetCurrentPedWeapon(ped, GetHashKey("WEAPON_UNARMED"), true)
        playAnim(true, { { "random@mugging3", "handsup_standing_base" } }, true)
    else
        ExecuteCommand("clear")
    end
end, false)

RegisterKeyMapping("handsup", "Levantar/Abaixar Mãos", "keyboard", "X")

-- export so other resources can retrieve the animation list
exports('GetAnimations', function()
    return animacoes
end)
RegisterKeyMapping("clear", "Cancelar Animação", "keyboard", "F6")